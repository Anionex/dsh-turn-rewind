...
function RewindTurnTail({ matched, sessionId, openSession }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "dcl-rewind-tail", children: [(0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Tooltip, { label: `回退到第 ${String(matched.turn)} 轮结束时`, side: "bottom", children: (0, jsx_runtime_1.jsxs)("button", { type: "button", className: "dcl-rewind-trigger", onClick: show, "aria-label": `回退到第 ${String(matched.turn)} 轮结束时`, children: [(0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.IconRefreshOutline16, { size: 16 }), (0, jsx_runtime_1.jsx)("span", { children: "\u56DE\u9000" })] }) }), (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Modal, { open: open, onClose: close, title: `回退到第 ${String(matched.turn)} 轮结束时`, closeLabel: "\u5173\u95ED", description: "\u9009\u62E9\u8981\u6062\u590D\u7684\u8303\u56F4\u3002\u539F\u5BF9\u8BDD\u59CB\u7EC8\u4FDD\u7559\uFF1B\u6D89\u53CA\u4EE3\u7801\u65F6\u4F1A\u518D\u6B21\u9A8C\u8BC1\u5DE5\u4F5C\u533A\u5E76\u5148\u521B\u5EFA\u6551\u63F4\u70B9\u3002", footer: ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Button, { variant: "outline", onClick: close, disabled: applying, children: "\u53D6\u6D88" }), (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Button, { variant: "primary", onClick: () => { void applyRestore(); }, disabled: !canApply, children: applying ? '正在回退…' : completed === null ? actionLabel : '已完成' })] })), children: (0, jsx_runtime_1.jsxs)("div", { className: "dcl-rewind-body", children: [loading && (0, jsx_runtime_1.jsx)("p", { children: "\u6B63\u5728\u8BFB\u53D6\u6B64\u8F6E\u6062\u590D\u70B9\u2026" }), preview?.status === 'pending' && (0, jsx_runtime_1.jsx)("p", { children: "\u6B64\u8F6E\u68C0\u67E5\u70B9\u4ECD\u5728\u5199\u5165\uFF0C\u8BF7\u7A0D\u540E\u91CD\u8BD5\u3002" }), preview?.status === 'missing' && (0, jsx_runtime_1.jsx)("p", { className: "dcl-rewind-error", children: "\u6CA1\u6709\u627E\u5230\u6B64\u8F6E\u68C0\u67E5\u70B9\uFF1B\u8BE5\u8F6E\u53EF\u80FD\u65E9\u4E8E\u63D2\u4EF6\u542F\u7528\u65F6\u95F4\u6216\u5DF2\u8D85\u8FC7\u4FDD\u7559\u7A97\u53E3\u3002" }), preview?.status === 'failed' && (0, jsx_runtime_1.jsxs)("p", { className: "dcl-rewind-error", children: ["\u68C0\u67E5\u70B9\u521B\u5EFA\u5931\u8D25\uFF1A", preview.error] }), ready !== null && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("div", { className: "dcl-rewind-options", children: [(0, jsx_runtime_1.jsxs)("label", { className: "dcl-rewind-option", "data-selected": mode === 'both', "data-disabled": applying, children: [(0, jsx_runtime_1.jsx)("input", { type: "radio", name: radioName, checked: mode === 'both', disabled: applying, onChange: () => { chooseMode('both'); } }), (0, jsx_runtime_1.jsxs)("span", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "\u540C\u65F6\u6062\u590D\u4EE3\u7801\u4E0E\u5BF9\u8BDD" }), (0, jsx_runtime_1.jsx)("span", { children: "\u6062\u590D\u5DE5\u4F5C\u533A\uFF0C\u5E76\u521B\u5EFA\u3001\u6253\u5F00\u6B64\u8F6E\u7ED3\u675F\u65F6\u7684\u5BF9\u8BDD\u7248\u672C\uFF1B\u539F\u5BF9\u8BDD\u4FDD\u7559\u3002" })] })] }), (0, jsx_runtime_1.jsxs)("label", { className: "dcl-rewind-option", "data-selected": mode === 'code', "data-disabled": applying || ready.totalChanges === 0, children: [(0, jsx_runtime_1.jsx)("input", { type: "radio", name: radioName, checked: mode === 'code', disabled: applying || ready.totalChanges === 0, onChange: () => { chooseMode('code'); } }), (0, jsx_runtime_1.jsxs)("span", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "\u4EC5\u6062\u590D\u4EE3\u7801" }), (0, jsx_runtime_1.jsx)("span", { children: ready.totalChanges === 0 ? '当前代码已经与该轮一致，无需恢复。' : '对话保持当前位置，只把工作区恢复到此轮结束时。' })] })] }), (0, jsx_runtime_1.jsxs)("label", { className: "dcl-rewind-option", "data-selected": mode === 'conversation', "data-disabled": applying, children: [(0, jsx_runtime_1.jsx)("input", { type: "radio", name: radioName, checked: mode === 'conversation', disabled: applying, onChange: () => { chooseMode('conversation'); } }), (0, jsx_runtime_1.jsxs)("span", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "\u4EC5\u56DE\u9000\u5BF9\u8BDD" }), (0, jsx_runtime_1.jsx)("span", { children: "\u521B\u5EFA\u5E76\u6253\u5F00\u6B64\u8F6E\u7ED3\u675F\u65F6\u7684\u5BF9\u8BDD\u7248\u672C\uFF1B\u5F53\u524D\u4EE3\u7801\u4FDD\u6301\u4E0D\u53D8\u3002" })] })] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dcl-rewind-summary", children: [(0, jsx_runtime_1.jsxs)("span", { children: [String(ready.totalChanges), " \u4E2A\u4EE3\u7801\u8DEF\u5F84\u4E0E\u8BE5\u8F6E\u4E0D\u540C"] }), (0, jsx_runtime_1.jsx)("span", { children: needsCodeRestore ? '恢复前自动创建救援点' : '不会修改当前代码' })] }), needsCodeRestore && (ready.headChanged || ready.operationChanged) && ((0, jsx_runtime_1.jsx)("p", { className: "dcl-rewind-warning", children: "Git HEAD\u3001\u5206\u652F\u6216\u8FDB\u884C\u4E2D\u7684 Git \u64CD\u4F5C\u5DF2\u7ECF\u53D8\u5316\u3002\u4E3A\u907F\u514D\u8DE8\u5386\u53F2\u6062\u590D\uFF0C\u8BF7\u5148\u5904\u7406\u8BE5\u53D8\u5316\u540E\u91CD\u65B0\u6253\u5F00\u3002" })), !restoresCode && (ready.headChanged || ready.operationChanged) && ((0, jsx_runtime_1.jsx)("p", { children: "\u4EC5\u56DE\u9000\u5BF9\u8BDD\u4E0D\u4F1A\u4FEE\u6539\u5DE5\u4F5C\u533A\uFF0C\u56E0\u6B64\u4E0D\u53D7\u5F53\u524D HEAD \u6216 Git \u64CD\u4F5C\u72B6\u6001\u5F71\u54CD\u3002" })), planMissing && (0, jsx_runtime_1.jsx)("p", { className: "dcl-rewind-error", children: "\u4EE3\u7801\u6062\u590D\u8BA1\u5212\u7F3A\u5931\uFF0C\u8BF7\u5173\u95ED\u540E\u91CD\u65B0\u6253\u5F00\u56DE\u9000\u7A97\u53E3\u3002" }), ready.totalChanges === 0 && (0, jsx_runtime_1.jsx)("p", { children: "\u5F53\u524D\u5DE5\u4F5C\u533A\u5DF2\u7ECF\u4E0E\u8BE5\u8F6E\u7ED3\u675F\u72B6\u6001\u4E00\u81F4\uFF1B\u201C\u540C\u65F6\u56DE\u9000\u201D\u5C06\u53EA\u521B\u5EFA\u5BF9\u8BDD\u7248\u672C\u3002" }), ready.changes.length > 0 && ((0, jsx_runtime_1.jsxs)("div", { className: "dcl-rewind-files", children: [ready.changes.map(change => (0, jsx_runtime_1.jsxs)("div", { className: "dcl-rewind-file", children: [(0, jsx_runtime_1.jsx)("code", { children: change.path }), (0, jsx_runtime_1.jsx)("span", { className: "dcl-rewind-kind", children: kindLabel(change.kind) })] }, change.path)), ready.truncated && (0, jsx_runtime_1.jsx)("div", { className: "dcl-rewind-file", children: (0, jsx_runtime_1.jsx)("span", { children: "\u5176\u4F59\u8DEF\u5F84\u672A\u5728\u6B64\u5904\u5C55\u5F00" }) })] })), needsCodeRestore && !driftBlocked && !planMissing && ((0, jsx_runtime_1.jsxs)("label", { className: "dcl-rewind-ack", children: [(0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: acknowledged, disabled: applying, onChange: event => { setAcknowledged(event.currentTarget.checked); } }), (0, jsx_runtime_1.jsx)("span", { children: "\u6211\u786E\u8BA4\u6062\u590D\u4EE5\u4E0A\u4EE3\u7801\u53D8\u5316\uFF1B\u5F53\u524D\u4EE3\u7801\u4F1A\u5148\u4FDD\u5B58\u5230\u6551\u63F4\u70B9\uFF0C\u539F\u5BF9\u8BDD\u4E0D\u4F1A\u88AB\u5220\u9664\u3002" })] }))] })), completed !== null && (0, jsx_runtime_1.jsx)("p", { children: completed }), error !== null && (0, jsx_runtime_1.jsx)("p", { className: "dcl-rewind-error", children: error }), !loading && preview?.status !== 'ready' && (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Button, { variant: "outline", size: "sm", onClick: () => { void load(true); }, children: "\u91CD\u8BD5" })] }) })] }));
}
